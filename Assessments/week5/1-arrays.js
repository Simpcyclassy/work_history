...
let oils = ['Coconut oil', 'PalmKernel oil', 'Olive oil', 'Avocado oil', 'Papaya oil'];

function hairProducts(oils) {
...
let oils = ['Coconut oil', 'PalmKernel oil', 'Olive oil', 'Avocado oil', 'Papaya oil'];
 ...
 let butter = 'SheaButter';

 function hairMassage(oils, butter) {
 const MassagePros = oils.unshift(butter); {
   return oils;
   }
}
...
let oils = ['Coconut oil', 'PalmKernel oil', 'Olive oil', 'Avocado oil', 'Papaya oil'];
 ...
 function hairMassage(oils, butter) {
 const MassagePros = oils.push(butter); {
   return oils;
   }
}
hairMassage(oils, butter);
